...
namespace WpfApplication1
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private bool findCross(Skeleton skeleton, JointType joint0, JointType joint1, JointType joint2, JointType joint3)
        {
            ...
            if ((HandRight.Position.X < HandLeft.Position.X) && (ElbowRight.Position.Y < HandLeft.Position.Y) && (ElbowLeft.Position.Y < HandLeft.Position.Y) && (ElbowRight.Position.Y < HandRight.Position.Y) && (ElbowLeft.Position.Y < HandRight.Position.Y) && (ElbowLeft.Position.X < ElbowRight.Position.X))
            {
                Label1.Content = "Revoke Last Signal";

            }

            else if (Label1.Content == "Rovoke Last Signal")
            {
                Label1.Content = "";
            }
            return true;
        ...
        private bool findDeadBall(Skeleton skeleton, JointType joint0, JointType joint1, JointType joint2, JointType joint3)
        {
            ...
            if ((HandRight.Position.X < HandLeft.Position.X) && (ElbowRight.Position.Y > HandLeft.Position.Y) && (ElbowLeft.Position.Y > HandLeft.Position.Y) && (ElbowRight.Position.Y > HandRight.Position.Y) && (ElbowLeft.Position.Y > HandRight.Position.Y) && (ElbowLeft.Position.X < ElbowRight.Position.X))
            {
                Label1.Content = "Dead Ball";

            }

            else if (Label1.Content == "Dead Ball")
            {
                Label1.Content = "";
            }
            return true;
        ...
        private bool findhorizontalhand(Skeleton skeleton, JointType joint0, JointType joint1, JointType joint2, JointType joint3, JointType joint4, JointType joint5, JointType joint6)
        {
            ...
            else if(Label1.Content=="Wide" || Label1.Content=="No Ball")
            {
                Label1.Content = "";
        ...
        private bool findRaise(Skeleton skeleton, JointType joint0, JointType joint1, JointType joint2, JointType joint3)
        {
            ...
            else if (Label1.Content == "Six" || Label1.Content == "Out")
            {
                Label1.Content = "";
            }
            return true;
        ...
        private bool findLegByeRight(Skeleton skeleton, JointType joint0, JointType joint1, JointType joint2, JointType joint3)
        {
            ...
            if (Math.Abs(HipRight.Position.X - KneeRight.Position.X) < 0.35 && Math.Abs(HipRight.Position.Y - KneeRight.Position.Y) < 0.4 && HipRight.Position.Z > KneeRight.Position.Z && Math.Abs(HandRight.Position.X - KneeRight.Position.X) < 0.15 && Math.Abs(HandRight.Position.Y - KneeRight.Position.Y) < 0.15 && (HipRight.Position.Z >= HandRight.Position.Z && HandRight.Position.Z >= KneeRight.Position.Z))
            {
                Label1.Content = "Leg Bye";
                return true;
            }
